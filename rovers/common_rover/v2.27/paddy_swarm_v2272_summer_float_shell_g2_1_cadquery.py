...
# -*- coding: utf-8 -*-
"""
Paddy Swarm Common Rover v2.27.2.1 Retrofit Summer Float Shell G2.1
================================================================
...
- This is NOT a waterproof guarantee.  Use test weights for water tests first.

Expected commands
-----------------
python paddy_swarm_v2272_summer_float_shell_g2_cadquery.py --out rover_v2272_sfs_g21_out --make-zip
python paddy_swarm_v2272_summer_float_shell_g2_cadquery.py --metadata-only --out rover_v2272_sfs_g21_meta --make-zip
"""
...
PARTS = [
    ...
    PartSpec(
        ...
        "printable adapter saddle for existing FLT-RCV receiver; side-float mount",
...
DESIGN_CONTRACT = {
    ...
    "safety_policy": [
        ...
        "Use test weights, not electronics, for first float/water tests.",
    ],
...
def parse_args(argv: Optional[Iterable[str]] = None):
    ...
    ap.add_argument("--out", default="rover_v2272_sfs_g21_out")
