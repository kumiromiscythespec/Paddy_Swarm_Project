...
# -*- coding: utf-8 -*-
"""
Paddy Swarm A1 Dense Project Tools v5.7
...
def read_manifest(manifest: Path, base_dir: Optional[Path] = None, tpu_patterns: Optional[List[str]] = None) -> List[Item]:
    ...
    with manifest.open("r", newline="", encoding="utf-8-sig") as f:
        ...
        for r in reader:
            ...
            if r.get("is_tpu", "").strip() in {"1", "true", "TRUE", "yes", "YES"} or material_hint == "TPU":
                material = "TPU"
            else:
...
def main():
    ...
    ap.add_argument("--make-model-dense-sets", action="store_true", help="v5.7: write three dense sets: rigid_plus_metal, rigid_only, and tpu_only")
