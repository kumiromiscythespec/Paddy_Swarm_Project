"""Full-height Phase 3R shell and large-ring planting-port reference."""
...
PRINT_STATUS = "DO_NOT_PRINT_UNTIL_PHASE3R_PHYSICAL_CALIBRATION"
...
def build_full_module_reference_phase3r() -> cq.Workplane:
    shapes: list[cq.Shape] = [build_three_port_module_shell_phase3r().val()]
